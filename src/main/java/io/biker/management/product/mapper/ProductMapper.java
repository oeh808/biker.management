...
public class ProductMapper {
    ...
    public ProductReadingDTO toDto(Product product) {
        ProductReadingDTO dto = new ProductReadingDTO(product.getProductId(), product.getName(),
    ...
    public List<ProductReadingAdminDTO> toDtosAdmim(List<Product> products) {
        List<ProductReadingAdminDTO> dtos = new ArrayList<>();
        for (Product product : products) {
            dtos.add(toDtoAdmin(product));
        }
