create table orders (
    ...
    ), estimatedTimeOfArrival date, store_id integer, vat float(23), total_cost float(23), street varchar(255), city varchar(255), country varchar(255), state varchar(255), post_code varchar(255), biker_id integer, rating integer, review varchar(255), primary key (order_id)
) engine = InnoDB;
